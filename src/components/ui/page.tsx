...
function HeroSection({ profile, heroCarousel }: { profile: Profile; heroCarousel: HeroCarousel[] }) {
  ...
  return (
    <section className="relative">
      {/* Cover Image - Fixed height, slightly increased for mobile */}
      <div className="relative h-56 sm:h-56 md:h-64 lg:h-72 bg-linear-to-br from-amber-200 via-amber-100 to-orange-100 border-b-2 border-foreground/10 overflow-hidden">
      ...
      <div className="container mx-auto px-4 min-[480px]:px-5 sm:px-6 lg:px-8">
          ...
          <div className="flex-1 min-w-0 text-center md:text-left md:pt-1">
            ...
            <div className="hidden md:flex items-center gap-2 lg:gap-3 justify-center md:justify-start">
              ...
              <div className="flex items-center gap-2 lg:gap-2.5 ml-1">
                <Link href={profile.github_url || "#"} target="_blank" className="p-2 lg:p-2.5 bg-card border-2 border-stone-900 text-muted-foreground hover:text-foreground rounded-md shadow-[1px_1px_0px_0px_rgba(0,0,0,0.3)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all">
                  <Github className="h-5 w-5 lg:h-5.5 lg:w-5.5" />
                </Link>
                <Link href={profile.linkedin_url || "#"} target="_blank" className="p-2 lg:p-2.5 bg-card border-2 border-stone-900 text-muted-foreground hover:text-foreground rounded-md shadow-[1px_1px_0px_0px_rgba(0,0,0,0.3)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all">
                  <Linkedin className="h-5 w-5 lg:h-5.5 lg:w-5.5" />
                </Link>
                <Link href={profile.facebook_url || "#"} target="_blank" className="p-2 lg:p-2.5 bg-card border-2 border-stone-900 text-muted-foreground hover:text-foreground rounded-md shadow-[1px_1px_0px_0px_rgba(0,0,0,0.3)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all">
        ...
        <div className="md:hidden mt-4 min-[480px]:mt-5 sm:mt-6 w-full">
          ...
          <div className="w-full flex flex-col sm:flex-row gap-3 sm:gap-2.5">
            ...
            <div className="flex items-center gap-2.5 justify-center sm:justify-start">
              <Link href={profile.github_url || "#"} target="_blank" className="p-2.5 sm:p-3 bg-card border-2 border-stone-900 text-muted-foreground hover:text-foreground rounded-md shadow-[1px_1px_0px_0px_rgba(0,0,0,0.3)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all">
                <Github className="h-5.5 w-5.5 sm:h-6 sm:w-6" />
              </Link>
              <Link href={profile.linkedin_url || "#"} target="_blank" className="p-2.5 sm:p-3 bg-card border-2 border-stone-900 text-muted-foreground hover:text-foreground rounded-md shadow-[1px_1px_0px_0px_rgba(0,0,0,0.3)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all">
                <Linkedin className="h-5.5 w-5.5 sm:h-6 sm:w-6" />
              </Link>
              <Link href={profile.facebook_url || "#"} target="_blank" className="p-2.5 sm:p-3 bg-card border-2 border-stone-900 text-muted-foreground hover:text-foreground rounded-md shadow-[1px_1px_0px_0px_rgba(0,0,0,0.3)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.2)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all">
        ...
        <div className="py-8 min-[480px]:py-10 sm:py-12 md:py-14">
          <h3 className="text-lg min-[480px]:text-xl sm:text-2xl font-black text-muted-foreground mb-4 min-[480px]:mb-5 font-[family-name:var(--font-space)]">Roles, Interests & Achievements</h3>
      ...
      <div className="container mx-auto px-2 min-[480px]:px- sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-2 sm:gap-2.5 md:gap-3">
          {featuredProjects.map((project, index) => (
            <Card 
              key={project.id} 
              className={`overflow-hidden group bg-card border-2 border-stone-900 rounded-lg shadow-[1px_1px_0px_0px_rgba(0,0,0,0.15)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.1)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all p-0
            ...
            >
              ...
              <div className="relative w-full aspect-video bg-amber-50 border-b-2 border-stone-900 overflow-hidden">
                ...
                <div className="absolute top-1.5 right-1.5 flex gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                  {project.live_url && (
                    <Link href={project.live_url} target="_blank" className="p-1 bg-white border border-stone-900 text-stone-700 hover:bg-stone-100 rounded">
                      <ExternalLink className="h-3.5 w-3.5 sm:h-4 sm:w-4" />
                    </Link>
                  )}
                  {project.github_url && (
                    <Link href={project.github_url} target="_blank" className="p-1 bg-white border border-stone-900 text-stone-700 hover:bg-stone-100 rounded">
              ...
              <div className="flex-1 flex items-center justify-center px-1 sm:px-2 md:px-3 py-1 sm:py-1.5">
                <h3 className="font-bold text-sm sm:text-base md:text-lg leading-snug group-hover:text-amber-700 transition-colors font-[family-name:var(--font-space)] text-center">
                  {project.title}
                </h3>
              </div>
            </Card>
      ...
      <div className="container mx-auto px-4 min-[480px]:px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {education.map((edu) => {
            ...
            return (
            <Card key={edu.id} className="group bg-card overflow-hidden border-2 border-stone-900 rounded-lg shadow-[1px_1px_0px_0px_rgba(0,0,0,0.15)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.1)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all p-4 sm:p-5">
              <div className="flex items-start gap-3 sm:gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    <h3 className="font-bold text-base sm:text-lg leading-tight truncate font-[family-name:var(--font-space)]">{edu.degree}</h3>
                    {isCurrent && (
                      <span className="text-[10px] sm:text-xs font-bold bg-emerald-400 text-white px-2 py-0.5 border border-stone-900 rounded shrink-0">NOW</span>
                    )}
                  </div>
                  <p className="text-sm sm:text-base text-amber-700 font-semibold truncate font-[family-name:var(--font-space)]">{edu.institution}</p>
                  ...
                  <div className="flex flex-wrap items-center gap-2 mt-2 text-xs sm:text-sm text-muted-foreground">
                    ...
                    {edu.grade && (
                      <span className="inline-flex items-center gap-1 font-bold text-amber-700 bg-amber-100 px-1.5 py-0.5 border border-amber-300 rounded">
                  ...
                  {!isCurrent && (
                    <button className="mt-3 flex items-center gap-1.5 text-xs sm:text-sm font-bold text-violet-700 bg-violet-100 px-2 py-1 border border-violet-300 rounded hover:bg-violet-200 transition-colors">
      ...
      <div className="container mx-auto px-4 min-[480px]:px-5 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
          {experiences.map((exp) => {
            ...
            return (
            <Card key={exp.id} className="group bg-card overflow-hidden border-2 border-stone-900 rounded-lg shadow-[1px_1px_0px_0px_rgba(0,0,0,0.15)] hover:shadow-[0.5px_0.5px_0px_0px_rgba(0,0,0,0.1)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all p-4 sm:p-5">
              <div className="flex items-start gap-3 sm:gap-4">
                {/* Icon or Logo */}
                {exp.logo_url ? (
                  <div className="relative h-12 w-12 sm:h-14 sm:w-14 shrink-0 border-2 border-stone-900 bg-white overflow-hidden rounded">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {isCurrent && (
                      <span className="text-[10px] sm:text-xs font-bold bg-emerald-400 text-white px-2 py-0.5 border border-stone-900 rounded shrink-0">ACTIVE</span>
                    )}
                  </div>
